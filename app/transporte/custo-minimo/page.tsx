...
export default function CustoMinimoPage() {
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    try {
      ...
      const prompt = `Resolva o seguinte problema de transporte usando o método do custo mínimo:
  ...
  return (
    <div className="container mx-auto p-4">
      <h1 className="text-3xl font-bold mb-6">Método do Custo Mínimo</h1>
